...
<table>
    ...
    <tr>
        ...
        <td>Connect the SCART cable to your TV, then plug in power. If you are using a CSYNC cable and your TV is configured to the right input, you should be able to see the video and hear the audio output from your Uzebox on your TV. Give yourself a double pat on the back!<br/><br/>If you are using a CVBS cable you have to apply the <a href="https://uzebox.org/wiki/Omega#Known_issues_and_fixes">video sync fix.</a> It is recommended that all Omega users of versions v1.1 to v1.4 apply the video sync fix.</td>
    </tr>
</table>
